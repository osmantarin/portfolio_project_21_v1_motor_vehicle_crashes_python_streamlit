...
DATA_URL = (
    "C:\\Users\\itsno\\Desktop\\Portfolio Projects\\portfolio_project_21_v1_motor_vehicle_crashes_python_streamlit\\csv_data\\Motor_Vehicle_Collisions_Crashes.csv"
)
...
st.markdown("Vehicle collisions between %d:00 and %d:00" % (hour, (hour + 1) % 24))
